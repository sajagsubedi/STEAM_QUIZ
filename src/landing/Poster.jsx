    ...
    >
      ...
      <div
        style={{
          ...
          pointerEvents: "none",
          boxShadow:
            "0 0 32px 8px #00eaff, 0 0 48px 16px #ff00ea, 0 0 0 8px #181818 inset",
        }}
      >
        <svg
          width="100%"
      ...
      <div
        style={{
          ...
          zIndex: 0,
          background:
            "radial-gradient(circle at 20% 30%, rgba(0, 234, 255, 0.3) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(255, 0, 234, 0.3) 0%, transparent 50%)",
          pointerEvents: "none",
        }}
      >
        <div
        ...
        <div
          style={{
            ...
            height: "2px",
            background:
              "linear-gradient(90deg, transparent, #ff00ea, transparent)",
      ...
      >
        ...
        <div
          style={{
            ...
            fontSize: "1.5rem",
            boxShadow:
              "0 0 24px 8px rgba(124, 58, 237, 0.5), 0 0 32px 12px rgba(0, 234, 255, 0.3)",
        ...
        <div
          style={{
            ...
            marginBottom: 32,
            boxShadow:
              "0 0 24px 8px rgba(34, 211, 238, 0.5), 0 0 16px 4px rgba(22, 163, 74, 0.5)",
            display: "inline-block",
          }}
        >
          Grade : XI & XII
