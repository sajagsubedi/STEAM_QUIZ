...
const SubjectSelection = () => {
  const { currentRound, selectEliminationSubject, nextInRound } =
    useNavigationStore();
  ...
  return (
    <div className="h-screen w-screen bg-black flex flex-col overflow-hidden bg-linear-to-br from-gray-900 via-blue-900 to-black relative p-6 md:p-12">
      ...
      {/* SUBJECT GRID - 2x2 Layout with Slimmer Cards */}
        ...
        <div className="grid grid-cols-2 gap-6 max-w-4xl w-full">
          {subjects.slice(0, 4).map((subject, index) => (
            ...
            >
              ...
              {/* Corner Accents - Minimalist Style */}
